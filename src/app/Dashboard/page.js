...
// import InventoryPage from "@/app/InventoryPage/page";
...
//         if (docSnap.exists()) {
//           setPantryInitialized(docSnap.data().pantryInitialized);
//           if (!docSnap.data().pantryInitialized) {
...
//       handleOpen();
//     } else {
//       router.push(`?path=${text === "Dashboard" ? "/" : "/inventory"}`);
//       setMobileOpen(false);
//     }
//   };
...
//   const addItem = async (item, quantity, siUnit, imageURL) => {
//     if (user) {
//       try {
...
//       }
//       await addItem(itemName, quantity, siUnit, imgURL);
//       setItemName("");
//       setQuantity(1);
//       setSiUnit("");
//       setImage(null);
//       handleClose();
//       updatePantry(user.uid); // Refresh pantry list after adding item
...
//         }}
//       >
//         {path === "/" ? <UserDashboard /> : <InventoryPage />}
// </Stack>
//         <Modal
//           open={open}
//           onClose={handleClose}
...
//               />
//               <InputLabel id="si-unit-label">SI Unit</InputLabel>
//               <Select
    ...
    <div>
      ...
      >
        ...
        >
          ...
          >
            <Avatar
              sx={{ bgcolor: deepOrange[500], width: "5vh", height: "5vh" }}
            >
              {avatarLetter}
            </Avatar>
